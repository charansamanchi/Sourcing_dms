		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Repository for public share",
									"targetURL": "#publicrepository-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"publicrepository-display": {
								"semanticObject": "publicrepository",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=publicrepository",
									"url": sap.ui.require.toUrl("publicrepository")
								}
							}
						}
					}
